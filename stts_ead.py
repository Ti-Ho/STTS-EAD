...
class STTS_EAD(nn.Module):
    def __init__(self,
        ...
        self.recons_model = ReconsModel(window_size, lstm_hid, recon_hid_dim, out_dim, forecast_n_layers, dropout)
    ...
    def forward(self, x, target_node):
        ...
        recons = self.recons_model(hn)

        return pred_res, recons
